...
![image-20260312075014719](C:\Users\曹鹏飞\AppData\Roaming\Typora\typora-user-images\image-20260312075014719.png)
...
class NeuralNetwork(nn.Module):
    #设置三层
    def __init__(self):
        # def __int__(self):输入错误
        super().__init__()
        self.flatten = nn.Flatten()
        self.hidden1 = nn.Linear(28*28,128)#图像是灰度的，28x28像素的
 #中间隐藏层，起初可以少一层
        self.hidden2 = nn.Linear(128,256)
        self.hidden3 = nn.Linear(256,512)
        self.out = nn.Linear(512,10)#为什么是10层输出层？0-9一共10个数
#优化网络，优化这里！40-43行，47行到52行
    #设置数据流方向
    def forward(self,x):
        x = self.flatten(x)
        ...
        return x
#优化到正确率为99.97%
>>>>>>> 8dfa8df5bcec161d4de9a5fcee944fe2e80ae80c
